...
import { Mic, Video, Pause, Play, Square, Circle, Plus, Undo2, RefreshCcw } from 'lucide-react';
...
export function RecordingStudio({
  ...
  return (
    <div className="glass-card p-4 md:p-5">
      {/* Recording Screen */}
      <div className="relative aspect-video bg-slate-900/50 rounded-xl overflow-hidden mb-4 flex items-center justify-center">
        ...
        {recordingType === 'audio' && isActive && (
          <div className="flex flex-col items-center gap-4">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-rose-500/30 to-pink-600/30 flex items-center justify-center animate-pulse">
        ...
        {isStopped && recordedUrl && (
          recordingType === 'video' ? (
            ...
            <div className="flex flex-col items-center gap-6 w-full px-8">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-rose-500/20 to-pink-600/20 flex items-center justify-center">
        ...
        {isActive && topic && (
          <div className="absolute top-4 left-4 max-w-[70%] bg-black/60 backdrop-blur-sm px-4 py-2.5 rounded-xl">
